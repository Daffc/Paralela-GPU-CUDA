...
{
    int solucoes = 0, coluna = 1, linha = 0;
...
int main(int argc, char *argv[])
{
    ...
    cudaMalloc((void **)&respostas, rainhas * sizeof(unsigned int));    
    ...
    resposta = thrust::reduce(thrust::device, t_respostas, t_respostas + rainhas, 0);
